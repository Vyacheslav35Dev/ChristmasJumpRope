...
namespace YG
{
    ...
    {
        [Tooltip("?payload=\nÝòî çíà÷åíèå, êîòîðîå Âû áóäåòå ïåðåäàâàòü ñ ïîìîùüþ Deep Linking. Ìîæåòå íàïèñàòü ñëîâî, íàïðèìåð, debug è äîáàâèòü ñâîé ïàðîëü, íàïðèìåð, 123. Ïîëó÷èòñÿ debug123.")]
        public string payloadPassword = "debug123";
        [Tooltip("Îòîáðàæåíèå ïàíåëè óïðàâëåíèÿ â Unity Editor")]
